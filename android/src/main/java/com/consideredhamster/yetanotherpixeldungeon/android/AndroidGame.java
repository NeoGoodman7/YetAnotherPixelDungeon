...
import com.consideredhamster.yetanotherpixeldungeon.PDPreferences;
...
public class AndroidGame extends AndroidApplication {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		if (instance == null) {
			...
			PDPreferences.INSTANCE.set(instance.getPreferences("PixelDungeon"));
		} else {
			instance = this;
		}
		...
		if (YetAnotherPixelDungeon.landscape() != null) {
			instance.setRequestedOrientation( YetAnotherPixelDungeon.landscape() ?
		...
		config.useImmersiveMode = YetAnotherPixelDungeon.immersed();
		...
		initialize(new YetAnotherPixelDungeon(support), config);
		
	}

	@Override
	public void useImmersiveMode(boolean use) {
		config.useImmersiveMode = use;
