...
//        txtTitle.x = (int)(slotsWidth - txtTitle.width()) / 2;
        ...
        add( txtTitle );
         ...
         if( showGold ){
             ...
             PointerArea goldArea = new PointerArea( goldText.x, goldText.y, goldIcon.width() + goldText.width(), goldIcon.height() + goldText.height() ) {
                 @Override
         ...
         if( showAnkhs ){
             ...
             if( ankh != null ){
				 ...
				 PointerArea ankhArea = new PointerArea( ankhText.x, ankhText.y, ankhIcon.width() + ankhText.width(), ankhIcon.height() + ankhText.height() ) {
                     @Override
                     protected void onClick( PointerEvent touch ){
