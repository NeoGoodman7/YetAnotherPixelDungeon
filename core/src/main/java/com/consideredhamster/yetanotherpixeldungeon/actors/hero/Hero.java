...
//	};
    ...
    @Override
    public boolean act(){
        // DeviceCompat.log("Scene", "act " + curAction);
...
//					restoreHealth = false;
    ...
    public void readyGame() {
        ...
        if (GameScene.checkListener()) {
            GameScene.setDefaultCellListener();
        }
    }
    ...
    private boolean actMove( HeroAction.Move action ){
        // DeviceCompat.log("Scene", "actMove dst: " + action.dst);
        ...
        if( getCloser( action.dst ) ){
            ...
            // DeviceCompat.log("Scene", "getCloser failed");
...
//				}
    ...
    private boolean makeStep( int step ) {
        // DeviceCompat.log("Scene", "makeStep: " + step);
    ...
    public boolean handle( int cell ){
        // DeviceCompat.log("Scene", "handle cell: " + cell);
        if( cell == -1 ){
            return false;
        }
...
//                magBonus++;
            ...
            if( sprite != null ){
                GLog.p( TXT_NEW_LEVEL, lvl, join( ", ", bonusList ) );
