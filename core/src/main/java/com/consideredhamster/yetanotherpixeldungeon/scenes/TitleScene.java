...
public class TitleScene extends PixelScene {
    ...
    public void create() {
        ...
        float height = title.height +
                (landscape() ? DashboardItem.SIZE : DashboardItem.SIZE * 2 );
        ...
        version.x = w - version.width() - 6;
        version.y = h - version.height() - 3;
        add( version );
        ...
        PointerArea changelog = new PointerArea( version ) {
            @Override
            protected void onClick( PointerEvent touch ) {

                YetAnotherPixelDungeon.lastVersion( Game.versionCode );
        ...
        btnExit.setPos(w - btnExit.width() - 1, 1);
        add(btnExit);

        fadeIn();

        if( YetAnotherPixelDungeon.lastVersion() < Game.versionCode ) {
            YetAnotherPixelDungeon.lastVersion( Game.versionCode );
