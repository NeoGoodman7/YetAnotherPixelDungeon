...
public class PixelScene extends Scene {
	...
	@Override
	public void destroy() {
		// DeviceCompat.log("Scene", "destroy");
		super.destroy();
	...
	public static BitmapText createText( String text, float size ) {
		...
		// BitmapText result = new BitmapText( text, pixelFont );
	...
	// 	result.zoom(1/(float)defaultZoom * 0.85f);
	// 	return result;
	// }
